...
class adminTournametViewe extends StatefulWidget {
  const adminTournametViewe({Key? key}) : super(key: key);

  @override
  State<adminTournametViewe> createState() => _adminTournametVieweState();
}

class _adminTournametVieweState extends State<adminTournametViewe> {
