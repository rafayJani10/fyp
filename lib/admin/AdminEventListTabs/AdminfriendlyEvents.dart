...
class AdminFriendlyGame extends StatefulWidget {
  const AdminFriendlyGame({Key? key}) : super(key: key);

  @override
  State<AdminFriendlyGame> createState() => _AdminFriendlyGameState();
}

class _AdminFriendlyGameState extends State<AdminFriendlyGame> {
